...
print( '     *--------------------------------------------------------------*')
print( '     |           NKABS - N and K from Absorbance Spectrum           |') 
print( '     |                   Version: January, 2019                      |')
print( '     |                                                              |')
print( '     |           Astrochemisty and Astrophysics Group               |')
print( '     | LASA - Laboratorio de AStroquimica e Astrobiologia da Univap |')
print( '     |         Instituto de Pesquisa & Desenvolvimento              |')
print( '     |            Universidade do Vale do Paraiba                   |')
print( '     |  Authors: Dr. Will Robson and Dr. Sergio Pilling             |')
print( '     |                                                              |')
print( '     *--------------------------------------------------------------*')



print( "\n Insert the thickness (microns), no, substrate (n2) and MAPE cut"  "!\n")
d1 = input('\n d (Ex. 0.4):')
#d2 = d1*1E-6
...
nvis = input('\n no (Ex. 1.22):')
no=float(nvis)
nsubs = input('\n n2 - (Use 1.73 for CsI, 1.54 for KBr and 2.54 for ZnSe):')
n2 = float(nsubs)
pc = input('\n MAPE (Ex. 1 -> 1%):')

#aviso = raw_input("\n Start procedure? (YES - click enter; NO - Ctrl + D)")
...
inp_file = 'lab130K.txt'
filename = np.loadtxt(inp_file)
i = filename.shape[0]

#Convert ascii to vector
with open('lab130K.txt', 'r') as f2:
	lines = f2.readlines()
...
#define odd and even numbers
                ...
                for g in range(i):
                        ...
                        real = no + np1
                        Porc = ((g+1.)/i)*100.
                        print("Performing the calculation for the iteration:", VAL, Porc, result*100)
                        #print('MAPE:', result*100) 
                        f.write('{0:f} {1:f} \n'.format(xk[g], real))
                f.close()
#############################################################################
...
print( "\n The iteractions number was:", NI)
print( "======================================")

#exit=input('\n For exit, click Enter button')
